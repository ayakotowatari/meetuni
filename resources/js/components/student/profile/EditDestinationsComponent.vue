<template>
    <div>
        ...
        <div v-if="isEditingForDestinations">
            <v-row justify="center">
...
export default {
    ...
    methods: {
        ...mapMutations('student', {
            setIsEditing: 'setIsEditingForDestinations',
            hasFinishedEditing: 'hasFinishedEditingForDestinations'
        }),
        ...mapActions('student', [
            'updateDestinations'
        ]),
